...
import mods.scourgecraft.client.tileentity.TileEntityFactionSelector;
...
public class BlockFactionSelector extends Block {
	...
	*/
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
	    ...
	    {
	    	TileEntityFactionSelector te = (TileEntityFactionSelector)par1World.getBlockTileEntity(par2, par3, par4);
